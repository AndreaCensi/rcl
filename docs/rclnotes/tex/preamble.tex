...
%%% Biblatex
\usepackage[style=numeric-comp,sorting=none,firstinits=true, maxnames=10, bibstyle=numeric-urls-expdoi,abbreviate=true,defernums=true,eprint=false,backend=bibtex]{biblatex}
